...
_C.TASK.END_EFFECTOR_TO_GOAL_DISTANCE = CN()
_C.TASK.END_EFFECTOR_TO_GOAL_DISTANCE.TYPE = "EndEffectorToGoalDistance"
...
_C.TASK.PLACE_REWARD.INCLUDE_EE_TO_GOAL_DIST = False
